...
class GuaranteeModel
{
    ...
    public function getAll($query = null): array
    {
        ...
        while ($row = mysqli_fetch_assoc($rows)) {
            ...
            $guarantee["ma_chi_tiet_san_pham"] = $row["ma_chi_tiet_san_pham"];
    ...
    public function create($data): string
    {
        ...
        $ngay_het_han = date("Y-m-d H:i:s", intval($data["ngay_het_han"] / 1000));

        $sql = "INSERT INTO baohanh (`ma_chi_tiet_san_pham`, `ma_khach_hang`, `ngay_lap`, `ngay_het_han`)
                VALUES ('$ma_chi_tiet_san_pham', '$ma_khach_hang', '$ngay_lap', '$ngay_het_han');";
    ...
    public function get(int $id): array|false
    {
        ...
        $guarantee["ma_chi_tiet_san_pham"] = $data["ma_chi_tiet_san_pham"];
